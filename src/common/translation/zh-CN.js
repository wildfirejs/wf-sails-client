export const langZhCN = {
  ...
  PersonalCenter: {
    ...
    error: {
      deleting_notification: '系统消息删除失败。',
      fetching_notifications: '获取系统消息失败',
      toggling_read: '更改消息已读状态失败。',
    },
    success: {
      deleting_notification: '系统消息删除成功。',
      toggling_read: '更改消息已读状态成功。',
    },
    tab: {
      notification: '系统消息',
    },
    text: {
      ...
      new_disc_in_comment_mention: '<a title="{{email}}">{{displayName}}</a> 在你的评论的讨论中进行了 <a title="{{content}}">回复</a>，并 @ 了你。',
      ...
      new_reply_to_comment_mention: '<a title="{{email}}">{{displayName}}</a> 对你的评论进行了<a title="{{content}}">回复</a>，并 @ 了你。',
      notif_doesnt_exist: '该消息不存在。',
      related_content_no_longer_exists: '相关内容已不存在。',
      tips: '鼠标悬停在高亮文字上可查看更多内容；点击查看详情可跳转到相应网页。',
      unread_notification_n: '你有 {{unreadCount}} 条未读消息。',
      unread_notification_n_plural: '你有 {{unreadCount}} 条未读消息。',
    },
  },
  ReplyArea: {
    btn: {
  ...
  ReportManagement: {
    ...
    error: {
      ...
      ignoring_report: '忽略失败！',
      comment_no_longer_exist: '该评论已不存在。',
      unknown: '未知错误！',
    },
    success: {
      deleting_comment: '删除成功。',
