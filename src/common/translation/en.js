export const langEn = {
  ...
  PersonalCenter: {
    ...
    error: {
      deleting_notification: 'Failed to delete notification.',
      fetching_notifications: 'Failed to fetch notifications.',
      toggling_read: 'Failed to toggle state.',
    },
    success: {
      deleting_notification: 'Notification deleted.',
      toggling_read: 'Notification state changed.',
    },
    tab: {
      notification: 'Notification',
    },
    text: {
      ...
      new_disc_in_comment_mention: '<a title="{{email}}">{{displayName}}</a> posted <a title="{{content}}">new reply</a> in the discussion of your comment, and mentioned you.',
      ...
      new_reply_to_comment_mention: '<a title="{{email}}">{{displayName}}</a> posted <a title="{{content}}">new reply</a> to your comment, and mentioned you.',
      ...
      unread_notification_n: 'You have {{unreadCount}} unread notification.',
      unread_notification_n_plural: 'You have {{unreadCount}} unread notifications.',
    },
  },
  ReplyArea: {
    btn: {
  ...
  ReportManagement: {
    ...
    error: {
      ...
      ignoring_report: 'Failed to ignore.',
      comment_no_longer_exist: 'This comment no longer exist.',
